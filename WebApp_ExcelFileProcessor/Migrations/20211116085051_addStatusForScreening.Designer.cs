...
namespace WebApp_ExcelFileProcessor.Migrations
{
    ...
    [Migration("20211116085051_addStatusForScreening")]
    partial class addStatusForScreening
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp_ExcelFileProcessor.Models.ScreeningStatus", b =>
                {
                    b.Property<Guid>("ScreeningStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ScreeningStatusName")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ScreeningStatusId");

                    b.ToTable("ScreeningStatuses");
                });
            ...
            modelBuilder.Entity("WebApp_ExcelFileProcessor.Models.StudentScreening", b =>
                {
                    b.HasOne("WebApp_ExcelFileProcessor.Models.ScreeningStatus", "ScreeningStatus")
                        .WithMany()
                        .HasForeignKey("ScreeningStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
